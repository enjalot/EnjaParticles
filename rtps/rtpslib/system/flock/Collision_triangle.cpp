...
void FLOCK::loadCollision_tri()
{
    ...
    k_collision_tri.setArg(4, cl_FLOCKParams.getDevicePtr());
    // 5 = local triangles
    // ONLY IF DEBUGGING
...
void FLOCK::loadTriangles(std::vector<Triangle> triangles)
{
