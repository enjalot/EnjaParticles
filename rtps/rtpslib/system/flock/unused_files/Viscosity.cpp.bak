...
void FLOCK::loadViscosity()
{
    ...
    k_viscosity.setArg(4, cl_FLOCKParams.getDevicePtr());

} 


float FLOCK::Wviscosity(float4 r, float h)
{
    //from simple FLOCK in Krog's thesis
