...
__kernel void xflock(__global float4* pos, __global float4* veleval, __global float* density, __global float4* force, __global float4* xflock, __constant struct FLOCKParams* params)
{
