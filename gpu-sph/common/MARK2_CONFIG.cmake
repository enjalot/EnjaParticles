...
# I should not have to set 32 bit manually. Poor programming. 
#SET(GFORTRAN ${CMAKE_CURRENT_SOURCE_DIR}/lib/libgfortran.so CACHE STRING "32-bit gfortran library" FORCE) 
#SET(GFORTRANBEGIN ${CMAKE_CURRENT_SOURCE_DIR}/lib/libgfortranbegin.a CACHE STRING "32-bit gfortranbegin library" FORCE) 
# does not work
#FIND_LIBRARY(gcc_s gcc_s PATHS /lib)
FIND_LIBRARY(stdc stdc++ PATHS ${CMAKE_CURRENT_SOURCE_DIR}/lib)
#FIND_LIBRARY(GFORTRANBEGIN gfortranbegin PATHS ${CMAKE_CURRENT_SOURCE_DIR}/lib)
#FIND_LIBRARY(GFORTRAN gfortran PATHS ${CMAKE_CURRENT_SOURCE_DIR}/lib)
#SET(stdc ${CMAKE_CURRENT_SOURCE_DIR}/lib CACHE STRING "32-bit stdc++ library" FORCE) 
# does not work
