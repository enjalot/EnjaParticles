...
namespace SimLib
{
	...
	public:
		...
		//GE void InitializeD3D9(int cudaGLDevice, IDirect3DDevice9 *pDxDevice);
...
#endif
		// CUDA MAPPING
		//GE static cudaError_t MapBuffer(void **devPtr, IDirect3DResource9* pResource);
		//GE static cudaError_t UnmapBuffer(void **devPtr, IDirect3DResource9* pResource);
