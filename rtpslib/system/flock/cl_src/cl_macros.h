...
// boids macros
#define acc_separation(i)   force(i)
#define acc_alignment(i)    surface(i)
#define acc_cohesion(i)     xflock(i)
#define flockmates(i)       den(i).x
#define sep_flockmates(i)   den(i).y
