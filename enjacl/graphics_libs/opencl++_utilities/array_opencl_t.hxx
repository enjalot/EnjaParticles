...
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::ArrayOpenCLT() {
	//printf("inside arrayOpenCLT consructor 1\n");
	init();
}
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::ArrayOpenCLT(T* array, const Vec3i& n_) : AF(array, n_) {
	//printf("array_cuda_t, inside arrayOpenCLT consructor 2\n");
	init();
}
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::ArrayOpenCLT(T* array, const Vec3i& n_, const Vec3i& nm_) :
    AF(array, n_, nm_) {
	//printf("inside arrayOpenCLT consructor 3\n");
	init();
}
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::ArrayOpenCLT(const Vec3i& n_) : AF(n_) {
	//printf("inside arrayOpenCLT consructor 4\n");
	init();
}
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::ArrayOpenCLT(const Vec3i& n_, const Vec3i& nm_) : AF(n_, nm_) {
	//printf("inside arrayOpenCLT consructor 4\n");
	init();
}
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::ArrayOpenCLT(int n1_, int n2_, int n3_, int n1m_, int n2m_, int n3m_) :
    AF(n1_, n2_, n3_, n1m_, n2m_, n3m_) {
	init();
}
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::ArrayOpenCLT(T* array, const int* n_) : AF(array, n_) {
	init();
}
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::ArrayOpenCLT(T* array, int n1_, int n2_, int n3_, int n1m_, int n2m_, int n3m_) : AF(array, n1_, n2_, n3_, n1m_, n2m_, n3m_) {
	init();
}
//----------------------------------------------------------------------
template <class T>
ArrayOpenCLT<T>::~ArrayOpenCLT()
{
    //printf("inside ArrayOpenCLT destructor\n");
}
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::init()
{
	...
	//printf("*** enter ArrayOpenCLT::init, nbChannels= %d\n", nbChannels);
...
#if 0
template <class T>
void ArrayOpenCLT<T>::createPlan2D()
{
	//printf("np2,np3= %d, %d\n", this->np2, this->np3);
	if (this->np1 == 2) {
	} else {
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::createPlan1D(int nbBatches)
{
	//printf("np2,np3= %d, %d\n", this->np2, this->np3);
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::ifft2D(ArrayOpenCLT* B)
{
	if (B == 0) {
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::ifft2D(int offset, ArrayOpenCLT* B)
{
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::fft2D(ArrayOpenCLT* B)
{
	if (B == 0) {
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::fft1D(ArrayOpenCLT* B) // ideally, batch should be the last dimension
{
	if (B == 0) {
    	fft_status = cufftExecC2C(plan, (cufftComplex*) getDevicePtr(), (cufftComplex*) getDevicePtr(), CUFFT_FORWARD);
	} else {
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::setPlan2D_of(ArrayOpenCLT& A)
{
	plan = A.getPlan2D();
}
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::setPlan1D_of(ArrayOpenCLT& A)
{
	plan = A.getPlan1D();
}
//----------------------------------------------------------------------
template <class T>
cufftHandle ArrayOpenCLT<T>::getPlan2D()
{
	return plan;
}
//----------------------------------------------------------------------
template <class T>
cufftHandle ArrayOpenCLT<T>::getPlan1D()
{
	return plan;
}
#endif
...
#if 0
template <class T>
void ArrayOpenCLT<T>::setRandom_float2(float a, float b)
{
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::setRandom(float a, float b)
{
...
#if 0
template <class T>
void ArrayOpenCLT<T>::getType(int* nbComponents
	const char* tname = typeid(t).name();
...
#if 0
template <class T>
const char* ArrayOpenCLT<T>::getType()
{
	// check type of T 
	const char* tname = typeid(T).name();
...
#if 0
template <class T>
void ArrayOpenCLT<T>::setToFloat2(float2 f) // { printf("cannot set float 2 (gordon)\n"); }
{
	int np = this->npts;
	T* data = this->data;
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::setToFloat4(float4 f) // { printf("cannot set float 2 (gordon)\n"); }
{
	int np = this->npts;
	T* data = this->data;
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::setToInt2(int2 f)
{
	int np = this->npts;
	T* data = this->data;
...
//----------------------------------------------------------------------
template <class T>
void ArrayOpenCLT<T>::setToInt4(int4 f) 
{
	int np = this->npts;
	T* data = this->data;
