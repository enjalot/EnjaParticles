...
# setup environment variables for vislab
export ENJA_DIR=${HOME}/research/EnjaParticles/enjacl/

export BASE_DIR=${HOME}/vislab/src/heptadiagonal/gravimetrie_roland/branch_grav/branch3
