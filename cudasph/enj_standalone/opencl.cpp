...
void EnjaParticles::popCorn()
{
    ...
    //init_cl shouldn't change much, and this may
        ...
        //printf("c_vbo: %s\n", oclErrorString(err));
        cl_vbos.push_back(cl::BufferGL(context, CL_MEM_READ_WRITE, vel_vbo, &err));
    ...
    //{
        ...
        err = collision_kernel.setArg(1, cl_vbos[2]);   //velocities
    ...
    err = pos_update_kernel.setArg(2, cl_vbos[2]);   //velocities
