package com.enja.particlesfluid;
...
public class RTPS extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mGLView = new RTPSGLSurfaceView(this);
    ...
    static {
        System.loadLibrary("rtps");
    }
    

}

class RTPSGLSurfaceView extends GLSurfaceView {
    //private boolean moving = false;
    private static final String TAG = "RTPS";
    public RTPSGLSurfaceView(Context context) {
        super(context);
        mRenderer = new RTPSRenderer();
...
class RTPSRenderer implements GLSurfaceView.Renderer {
